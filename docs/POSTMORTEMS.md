...
**EVIDENCE (Machine-Copied Fact):**
```
<source>:22:10: fatal error: pkm_types.h: No such file or directory
   22 | #include "pkm_types.h"
      |          ^~~~~~~~~~~~~
compilation terminated.
```
...
**EVIDENCE (Machine-Copied Fact):**
```
<source>:27:10: fatal error: pkm_types.h: No such file or directory
   27 | #include "pkm_types.h"
      |          ^~~~~~~~~~~~~
compilation terminated.
```
...
**EVIDENCE (Machine-Copied Fact):**
```
<source>:13:10: fatal error: ../include/pkm_gesture_fsm.h: No such file or directory
   13 | #include "../include/pkm_gesture_fsm.h"
      |          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
compilation terminated.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on tee/duress-ta/host-tests/test_fsm.c.
...
**EVIDENCE (Machine-Copied Fact):**
```
<source>:26:10: fatal error: pkm_types.h: No such file or directory
   26 | #include "pkm_types.h"
      |          ^~~~~~~~~~~~~
compilation terminated.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on tee/duress-ta/include/pkm_gesture_fsm.h.
...
**EVIDENCE (Machine-Copied Fact):**
```
<source>:28:10: fatal error: types/pkm_types.h: No such file or directory
   28 | #include "types/pkm_types.h"
      |          ^~~~~~~~~~~~~~~~~~~
compilation terminated.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on tee/duress-ta/include/pkm_purge.h.
...
**EVIDENCE (Machine-Copied Fact):**
```
<source>:33:10: fatal error: pkm_types.h: No such file or directory
   33 | #include "pkm_types.h"
      |          ^~~~~~~~~~~~~
compilation terminated.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on tee/duress-ta/include/pkm_write_protect.h.

### ❌ [2026-09-09] tee/duress-ta/src/pkm_orchestrator.c `source: mutation-cycle`
**Symptom:** Active Linter / Compiler Gate Rejection on LLM Output (Option B)
**EVIDENCE (Machine-Copied Fact):**
```
<source>:10:10: fatal error: pkm_types.h: No such file or directory
   10 | #include "pkm_types.h"
      |          ^~~~~~~~~~~~~
compilation terminated.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on tee/duress-ta/src/pkm_orchestrator.c.

### ❌ [2026-09-09] tee/duress-ta/include/pkm_boot_corrupt.h `source: mutation-cycle`
**Symptom:** Active Linter / Compiler Gate Rejection on LLM Output (Option B)
**EVIDENCE (Machine-Copied Fact):**
```
<source>:18:10: fatal error: types/pkm_types.h: No such file or directory
   18 | #include "types/pkm_types.h"
      |          ^~~~~~~~~~~~~~~~~~~
compilation terminated.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on tee/duress-ta/include/pkm_boot_corrupt.h.

### ❌ [2026-09-09] tee/duress-ta/include/pkm_keys.h `source: mutation-cycle`
**Symptom:** Active Linter / Compiler Gate Rejection on LLM Output (Option B)
**EVIDENCE (Machine-Copied Fact):**
```
<source>:22:10: fatal error: pkm_types.h: No such file or directory
...
compilation terminated.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on tee/duress-ta/include/pkm_keys.h.
