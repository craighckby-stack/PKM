 ...
 * 
 * @return pkm_result_t PKM_SUCCESS on absolute hardware-confirmed destruction,
 ...
 * 
 * @return pkm_result_t PKM_SUCCESS on absolute memory sanitization confirmation,
 *         or an appropriate error code.
 */
